...
namespace Fiap.Api.Donation3.Migrations
{
    ...
    [Migration("20241022224303_TrocaWithUsuario")]
    partial class TrocaWithUsuario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fiap.Api.Donation3.Models.TrocaModel", b =>
                {
            ...
            modelBuilder.Entity("Fiap.Api.Donation3.Models.TrocaModel", b =>
                {
                    b.HasOne("Fiap.Api.Donation3.Models.ProdutoModel", "ProdutoEscolhido")
                        .WithMany()
                        .HasForeignKey("ProdutoIdEscolhido")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Fiap.Api.Donation3.Models.ProdutoModel", "ProdutoMeu")
                        .WithMany()
